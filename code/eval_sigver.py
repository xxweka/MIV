    ...
    with open(eval_file, 'r') as ef:
        ...
        for line in ef:
            ...
            if idx_gt and (labels[LABEL_KEYS['main']] == 1):
                ...
                # print(linecount, ':', 'AUC =', auroc, ', AP =', ap, ';', labels[LABEL_KEYS['main']], ',', y[0][0], '\n')
            linecount += 1
...
flags.DEFINE_string('model_file', 'ckpt/milmcase6heads-1se_EfficientNetV2B3tuning-excludeBN_019.hdf5',
